...
public class PropertyConfiguration implements Configuration {
    ...
    private static final String PROP_S3_COMPRESSION = "s3.compression";
    ...
    public boolean isCompressed(){
      String compress = props.getProperty(PROP_S3_COMPRESSION);
        return !(compress == null || compress.isEmpty()) && Boolean.parseBoolean(compress);
    }
}
